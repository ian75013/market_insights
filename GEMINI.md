...
This file defines execution rules for Google's AI assistants and IDEs in `Market Insights v4`:
...
## Project Context
Market Insights v4 — Plateforme de recherche actions avec **chandeliers annotés**, **RAG vectoriel** 
...
gemini context add . --name Market Insights v4
...
```bash
antigravity /path/to/Market Insights v4
```
