...
This file defines execution rules for Google's AI assistants and IDEs in `market_insights`:
...
## Project Context
market_insights — [Add project description here]
...
gemini context add . --name market_insights
...
```bash
antigravity /path/to/market_insights
```
